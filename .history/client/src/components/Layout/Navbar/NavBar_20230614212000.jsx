          ...
          <div className={`flex w-full navbar justify-between ${color}`}>
            ...
            <div className="xl:flex hidden">
              <ul className="menu menu-horizontal hover:text-white text-[16px] flex [&>li]:relative [&>li]:w-fit [&>li]:after:content-[''] [&>li]:after:block [&>li]:after:w-0 [&>li]:after:h-[3px] [&>li]:after:bg-white [&>li]:after:mx-auto hover:[&>li]:hover:after:w-full [&>li]:after:transition-all [&>li]:hover:transition-all [&>li]:after:duration-[0.8s] [&>li]:hover:duration-[0.8s] [&>li]:after:absolute [&>li]:after:bottom-[-30%] capitalize [&>li>ul]:absolute [&>li>ul]:shadow-xl [&>li>ul]:text-black [&>li>ul]:top-[150%] [&>li>ul]:bg-white [&>li>ul>li]:pl-6 [&>li>ul>li]:pr-2 [&>li>ul>li]:py-3 [&>li>ul]:flex-col [&>li>ul]:text-sm hover:[&>li>ul>li]:hover:bg-black/20 [&>li>ul>li>a]:block [&>li>ul>li>a]:w-full p-0">
                <li onClick={()=>handleUnderline(0)} className="active[] ?after:animate-still">
                  <Link to="/">
                    <span className="hover:text-white text-white">Trang chủ</span>
                  </Link>
                </li>
                <li onClick={()=>handleUnderline(1)} className="active[] ?group [&>ul]:hidden before:content-[''] before:w-full before:h-full before:bg-transparent before:block before:absolute relative before:top-[100%]">
                  <Link to="/about">
                ...
                <li onClick={()=>handleUnderline(2)} className="active[] ?group [&>ul]:hidden before:content-[''] before:w-full before:h-full before:bg-transparent before:block before:absolute relative before:top-[100%]">
                  <Link to="/products">
                ...
                <li onClick={()=>handleUnderline(3)} className="active[] ?group  [&>ul]:hidden before:content-[''] before:w-full before:h-full before:bg-transparent before:block before:absolute relative before:top-[100%]">
                  <Link to="/solutions">
                ...
                <li  onClick={()=>handleUnderline(4)} className="active[] ?group [&>ul]:hidden before:content-[''] before:w-full before:h-full before:bg-transparent before:block before:absolute relative before:top-[100%]">
                  <Link to="/posts">
                ...
                <li  onClick={()=>handleUnderline(5)} className="active[] ?group [&>ul]:hidden before:content-[''] before:w-full before:h-full before:bg-transparent before:block before:absolute relative before:top-[100%]">
                  <Link to="/faq">
                ...
                <li onClick={()=>handleUnderline(6)} className="active[] ?">
                  <Link to="/contact">
